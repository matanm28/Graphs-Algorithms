...
public class TestGraphAlgo {
    ...
    private static void test1() {
        ...
        IGraphAlgorithms algo = new GraphAlgorithms(graph);
    ...
    private static void test2() {
        ...
        IGraph graph = new UndirectedGraph();
        IGraphAlgorithms algo;
        //NodeData.countIndex = 0;

        for (int i = 0; i <= 9; i++) {
            INodeData newNode = new NodeData();
    ...
    private static void test4() {
        ...
        IGraphAlgorithms gra = new GraphAlgorithms(g);
    ...
    public static String printNi(INodeData node) {
        String str = "[";
        int a = 0;
        for (INodeData n : node.getNi()) {
            if (a == 0) {
                str += n.getKey();
            } else {
                str += " , " + n.getKey();
    ...
    public static String printNi2(Collection<INodeData> node, String result) {

        String str = "[";
        int a = 0;
        for (INodeData n : node) {
            if (a == 0) {
                str += n.getKey();
            } else {
                str += " , " + n.getKey();
    ...
    public static void printListOfPath(List<INodeData> list, int a, int b){
        System.out.println("the path from "+a+" -> "+b+" is : ");
        String path = "";
        if(list.size() != 0){
            for (INodeData n : list){
